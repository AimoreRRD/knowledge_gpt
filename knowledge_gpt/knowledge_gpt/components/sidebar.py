...
def sidebar():
    with st.sidebar:
        ...
        st.markdown("# About")
        st.markdown(
            "⚖️Resolution AI allows you to ask questions about your "
        ...
        st.markdown(
            ...
            When you ask a question, Resolution AI will search through the
            document chunks and find the most relevant ones using the vector index.
            Then, it will use GPT3 to generate a final answer.

            ## Is my data safe?
            Yes, your data is safe. Resolution AI does not store your documents or
            ...
            No, the answers are not 100% accurate. Resolution AI uses GPT-3 to generate
            answers. GPT-3 is a powerful language model, but it sometimes makes mistakes
            and is prone to hallucinations. Also, Resolution AI uses semantic search
            ...
            But for most use cases, Resolution AI is very accurate and can answer
